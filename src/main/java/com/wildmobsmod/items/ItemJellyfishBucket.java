...
public class ItemJellyfishBucket extends Item {
    public static final String[] field_150923_a = new String[] {"orange", "blue", "pink", "red", "yellow", "white"};
    public static final String[] field_150921_b = new String[] {"orange", "blue", "pink", "red", "yellow", "white"};
	...
	public ItemJellyfishBucket(){
        this.isFull = Blocks.flowing_water;
        this.maxStackSize = 1;
        this.setHasSubtypes(true);
        this.setMaxDamage(0);
		this.setCreativeTab(CreativeTabs.tabMisc);
		this.setTextureName("wildmobsmod:jellyfish_bucket");
    }
            ...
            if (movingobjectposition.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK)
            {
                ...
                else
                {
                    ...
                    if (this.tryPlaceContainedLiquid(p_77659_2_, i, j, k))
                    {
                    	...
                    	{
                    		int t = p_77659_1_.getItemDamage();
                    		Block block = p_77659_2_.getBlock(i, j, k);
                    		double d0 = 0.0D;

                    		EntityJellyfish entityliving = new EntityJellyfish(p_77659_2_);
