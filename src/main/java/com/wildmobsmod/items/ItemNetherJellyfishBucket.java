...
public class ItemNetherJellyfishBucket extends Item {
    @SideOnly(Side.CLIENT)
    private Block isFull;
    
	public ItemNetherJellyfishBucket(){
        this.isFull = Blocks.flowing_lava;
        this.maxStackSize = 1;
        this.setMaxDamage(0);
		this.setCreativeTab(CreativeTabs.tabMisc);
		this.setTextureName("wildmobsmod:jellyfish_bucket_nether");
    }
                ...
                else
                {
                    ...
                    if (this.tryPlaceContainedLiquid(p_77659_2_, i, j, k))
                    {
                    	if (!p_77659_2_.isRemote)
                    	{
                    		...
                    		entityliving.setSkin(6);
                    		entityliving.setNether(true);
