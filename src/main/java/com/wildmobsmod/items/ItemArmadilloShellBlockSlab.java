...
public class ItemArmadilloShellBlockSlab extends ItemBlock
{
    ...
    public ItemArmadilloShellBlockSlab(Block p_i45355_1_)
    {
        super(p_i45355_1_);
        this.field_150949_c = WildMobsModBlocks.armadilloShellBlockSlabSingle;
        this.field_150947_d = WildMobsModBlocks.armadilloShellBlockSlabDouble;
