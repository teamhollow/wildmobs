...
public class EntityMagmaPlant extends EntityLiving implements IMob {
	...
	public EntityMagmaPlant(World p_i1595_1_)
	{
		super(p_i1595_1_);
    ...
    public void readEntityFromNBT(NBTTagCompound p_70037_1_)
    {
        ...
        if (p_70037_1_.hasKey("Stage", 99))
        {
            byte b0 = p_70037_1_.getByte("Stage");
            this.setStage(b0);
        }
        this.setGrowingAge(p_70037_1_.getInteger("Age"));
        p_70037_1_.setBoolean("IsWild", this.getIsWild());
    }

    public void writeEntityToNBT(NBTTagCompound p_70014_1_)
    {
        super.writeEntityToNBT(p_70014_1_);
        p_70014_1_.setByte("Stage", (byte)this.getStage());
        p_70014_1_.setInteger("Age", this.getGrowingAge());
        this.setIsWild(p_70014_1_.getBoolean("IsWild"));
    }
    ...
    public boolean attackEntityFrom(DamageSource p_70097_1_, float p_70097_2_)
    {
        ...
        {
        	if (p_70097_1_ instanceof EntityDamageSource && this.spitting == false && this.getStage() >= 2)
        	{
        		this.spitting = true;
        	}
    ...
    protected void dropFewItems(boolean f1, int f2)
    {
    	if (this.getStage() >= 3)
    	{
    		...
    		int j = this.rand.nextInt(8) + this.rand.nextInt(1 + f2);
    		int k;
    		...
    		int i = 1 + (this.rand.nextInt(3) - 1) + this.rand.nextInt(1 + f2);
