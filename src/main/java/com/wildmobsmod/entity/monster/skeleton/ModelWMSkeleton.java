...
public class ModelWMSkeleton extends ModelZombie
{
    private static final String __OBFID = "CL_00000857";

    public ModelWMSkeleton()
    {
        this(0.0F);
    }

    public ModelWMSkeleton(float p_i1156_1_)
    {
    ...
    {
        this.aimedBow = ((EntityWMSkeleton)p_78086_1_).getSkeletonType() == 1;
