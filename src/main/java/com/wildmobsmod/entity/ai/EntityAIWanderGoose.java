...
public class EntityAIWanderGoose extends EntityAIBase
{
    ...
    public EntityAIWanderGoose(EntityCreature p_i1648_1_, double p_i1648_2_)
    {
    ...
    public boolean shouldExecute()
    {
        ...
        else if (this.entity.onGround == false)
        {
            return false;
        }
        else if (((EntityGoose)this.entity).getFlyingState() == 1)
        {
            return false;
        }
        else if (((EntityGoose)this.entity).getFlyingState() == 2)
        {
            return false;
        }
        else
