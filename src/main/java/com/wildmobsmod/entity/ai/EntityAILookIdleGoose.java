...
public class EntityAILookIdleGoose extends EntityAIBase
{
    ...
    public EntityAILookIdleGoose(EntityLiving p_i1647_1_)
    {
    ...
    {
    	if (this.idleEntity.onGround == false)
    	{
    		return false;
    	}
    	else if (((EntityGoose)this.idleEntity).getFlyingState() == 1)
    	{
    		return false;
    	}
    	else if (((EntityGoose)this.idleEntity).getFlyingState() == 2)
    	{
    		return false;
    	}
    	else
