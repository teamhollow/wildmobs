...
public class EntityTarantulaHair extends Entity implements IProjectile
{
    ...
    public EntityTarantulaHair(World p_i1753_1_)
    {
        super(p_i1753_1_);
    ...
    public EntityTarantulaHair(World p_i1754_1_, double p_i1754_2_, double p_i1754_4_, double p_i1754_6_)
    {
        super(p_i1754_1_);
        this.renderDistanceWeight = 10.0D;
        this.setSize(0.5F, 0.5F);
    ...
    public EntityTarantulaHair(World p_i1755_1_, EntityLivingBase p_i1755_2_, EntityLivingBase p_i1755_3_, float p_i1755_4_, float p_i1755_5_)
    {
        super(p_i1755_1_);
        this.renderDistanceWeight = 10.0D;
        this.shootingEntity = p_i1755_2_;

        this.posY = p_i1755_2_.posY + (double)p_i1755_2_.getEyeHeight();
    ...
    public EntityTarantulaHair(World p_i1756_1_, EntityLivingBase p_i1756_2_, float p_i1756_3_)
    {
        super(p_i1756_1_);
        this.renderDistanceWeight = 10.0D;
        ...
        else
        {
            ...
            if (movingobjectposition != null)
            {
                if (movingobjectposition.entityHit != null)
                {
                    ...
                    if (movingobjectposition.entityHit.attackEntityFrom(damagesource, f))
                    {
                        if (movingobjectposition.entityHit instanceof EntityLivingBase)
                        {
                            ...
                            if (this.knockbackStrength > 0)
                            {
                                ...
                                if (f4 > 0.0F)
                                {
                                    movingobjectposition.entityHit.addVelocity(this.motionX * (double)this.knockbackStrength * 0.4D / (double)f4, 0.1D, this.motionZ * (double)this.knockbackStrength * 0.4D / (double)f4);
                                }
                            }
