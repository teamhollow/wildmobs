...
public class EntityDireWolf extends EntityTameable
{
    ...
    {
        return (this.field_70924_f + (this.field_70926_e - this.field_70924_f) * p_70917_1_) * 0.08F * (float)Math.PI;
    }
        ...
        else if (itemstack != null && itemstack.getItem() == WildMobsModItems.thickBone && !this.isAngry())
        {
            ...
            if (!this.worldObj.isRemote)
            {
                if (this.rand.nextInt(4) == 0)
                {
                    ...
                    p_70085_1_.addStat(MainRegistry.achievementTameDireWolf, 1);
                }
                else
                {
    ...
    public EntityDireWolf createChild(EntityAgeable p_90011_1_)
    {
    ...
    public boolean canMateWith(EntityAnimal p_70878_1_)
    {
        ...
        else if (!(p_70878_1_ instanceof EntityDireWolf))
        {
            return false;
        }
        else
        {
            EntityDireWolf entitydirewolf = (EntityDireWolf)p_70878_1_;
            return !entitydirewolf.isTamed() ? false : (entitydirewolf.isSitting() ? false : this.isInLove() && entitydirewolf.isInLove());
        }
    }
    ...
    public boolean func_142018_a(EntityLivingBase p_142018_1_, EntityLivingBase p_142018_2_)
    {
        ...
        {
            if (p_142018_1_ instanceof EntityDireWolf)
            {
                EntityDireWolf entitywolf = (EntityDireWolf)p_142018_1_;
